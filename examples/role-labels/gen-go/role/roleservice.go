...
func (p *RoleServiceClient) recvSetRole() (err error) {
	...
	if method != "SetRole" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "SetRole failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "SetRole failed: invalid message type")
		return
	}
...
func (p *RoleServiceClient) recvGetMembers() (value []string, err error) {
	...
	if method != "GetMembers" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "GetMembers failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "GetMembers failed: invalid message type")
		return
	}
...
func (p *RoleServiceSetRoleArgs) readField1(iprot thrift.TProtocol) error {
...
func (p *RoleServiceSetRoleArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *RoleServiceSetRoleResult) Write(oprot thrift.TProtocol) error {
...
func (p *RoleServiceGetMembersArgs) readField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 1: ", err)
	} else {
		p.Role = v
...
func (p *RoleServiceGetMembersArgs) Write(oprot thrift.TProtocol) error {
...
func (p *RoleServiceGetMembersArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("role", thrift.STRING, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:role: ", p), err)
	}
	if err := oprot.WriteString(string(p.Role)); err != nil {
...
func (p *RoleServiceGetMembersResult) readField0(iprot thrift.TProtocol) error {
...
func (p *RoleServiceGetMembersResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
